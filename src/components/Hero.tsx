const Hero = () => {
  return (
    <section className="bg-white relative overflow-hidden">
       <div className="absolute left-1/3 bottom-0 -translate-x-1/2 translate-y-1/2 w-24 h-12 lg:h-16 rounded-t-full bg-[linear-gradient(180deg,rgba(247,102,128,1),rgba(87,0,123,1))] shadow-lg"></div>
